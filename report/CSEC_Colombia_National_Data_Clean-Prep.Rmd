---
title: "CSEC in Colombia: National Stratum- Data Cleaning & Prep"
...
Below is the code and output for the data cleaning and preparation of the national 2018 Colombia VACS sample prior to data analysis. I've annotated the steps I've taken for convenience.
...
The cleaned data-set ready for analysis is saved under '/data' as "Colombia_VACS_National_data_CLEANED.sav". 
...
A codebook of the selected variables and re-coding procedure is saved under '/codebook'.

The cleaned and structured data set is saved in SPSS format as .
