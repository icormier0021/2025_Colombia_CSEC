...
rawDF <- VACSData %>%
  select(
    ...
    H20, Sex, Q2, Q2A, Q3, Q13, Q19, Q29, Q50, Q55, Q58, Q70, Q71, Q306, Q21, Q31, Q7, Q36E,
    Q59, Q80, Q82, Q84, Q86,
    Q407, Q409, Q500, Q600,
...
df <- VACSData %>%
        ...
        mutate(
                ...
                FinanceSupport = recode(case_when(
                        H18 == 1 | H19 == 1                        ~1,
                        H18 == 2 & H19 != 1 | H19 == 2 & H18 != 1  ~0,
                        H18 %in% c(98,99,NA) & H19 %in% c(98,99,NA)~NA_real_
                        )),
                VictimReg = recode_bin(H19A),
                ParentAbs = case_when(
                                H54 %in% c(1,2,3,4)              ~1,
                                is.na(H54) & Q2 > 17 | H54 == 5  ~0,
                                H54 %in% c(98,99)                ~NA_real_
                                ),
                ...
                RomanticHx = case_when(
                        Q50 == 1 | Q55 == 1 | Q58 == 1 ~1,
                        Q58 == 2 & Q55 == 2 & Q58 == 2 ~0,
                        Q50 %in% c(98,99,NA) & Q55 %in% c(98,99,NA) & Q58 %in% c(98,99,NA) ~NA_real_
                ),
                ...
                SexTransact = case_when(
                        Q500 == 1             ~1,
                        Q407 == 2 | Q500 ==2  ~0,
                        Q500 %in% c(98,99,NA) ~NA_real_
                ),
...
df <- set_variable_labels(df,
                            ...
                            FinanceSupport = "Member of household receives financial government or non-government assistance",
                            ...
                            RomanticHx = "Ever been married, lived with a long-term romantic partner, or had a romantic partner",
