...
The cleaned and structured dataset ready for analysis is saved under the sub-directory 'data', and is named "Colombia_VACS_National_data_CLEANED". It is saved in both '.sav' and '.csv' format.
```{r saveData}
