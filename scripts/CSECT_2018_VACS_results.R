params <-
list(data = "./Colombia VACS SPSS data.sav")
...
packages <- c("survey", "haven", "dplyr", "labelled", "officer", "tidyr", "DT", "skimr", "ggplot2", "shiny", "knitr", "kableExtra", "svyweight", "scales", "purrr", "srvyr","tibble", "stringr")
...
## ----plotsHist, echo=FALSE, warning=FALSE, message=FALSE, results='asis'-----------------------------------------------------------------------------------------------------------------------------------
cat('<div style="
  height: 500px; 
  overflow-y: scroll; 
...
## ----plotsBar, echo=FALSE, warning=FALSE, message=FALSE, results='asis'------------------------------------------------------------------------------------------------------------------------------------
cat('<div style="
  height: 500px; 
  overflow-y: scroll; 
  border: 2px solid #ddd; 
...
## ----keyTbl, echo=FALSE, warning=FALSE, message=FALSE------------------------------------------------------------------------------------------------------------------------------------------------------
key <- tibble(
  `Code Line` = c(
    "`id = ~PSU`",
    "`strata = ~DEPT`",
...
## ----CSECDescripAge13to17, asis = TRUE---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
## ----CSECDescripAge18PlusCSEC, asis = TRUE-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
## ----DescriptivesAge13to17, asis = TRUE--------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
## ----DescriptivesAge18PlusCSEC, asis=TRUE------------------------------------------------------------------------------------------------------------------------------------------------------------------
